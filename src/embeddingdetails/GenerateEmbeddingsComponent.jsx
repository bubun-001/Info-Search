...
const GenerateEmbeddingsComponent = () => {
    ...
    const handleGenerateEmbeddings = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('/embedding_details/generate_embeddings_by_topic', {
                topic_name: formData.topic,
            });
            console.log(response.data);
            toast('Embeddings generated successfully.');
        } catch (error) {
            console.error('Error generating embeddings:', error);
            toast('Failed to generate embeddings.');
        }
    };
        ...
        <div className="flex justify-center mt-10">
            <div className="w-1/2">
              ...
              hover:scale-110 duration-300'
                            ...
                            style={{
                                backgroundColor: (formData.topic === '') ? '#f4f4f4' : 'linear-gradient(to bottom, #00b4d8, #0096c7)',
                                color: (formData.topic === '') ? '#ccc' : 'white',
...
export default GenerateEmbeddingsComponent;
